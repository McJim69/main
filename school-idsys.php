	...
	<div class="container" id="<?php echo $proj;?>">
		<h3><b><?php echo $name;?></b></h3>
			<p style="text-align:justify;margin-left:30px">
				The <?php echo $name;?> web application using PHP/MySQL is a project that serves as student profiling and ID management 
				system for local schools. This <?php echo $name;?> ease the burden of manual recording and isuance of Identification Card.
			</p> 			
			<p style="text-align:justify;margin-left:30px">
			...
			<p style="text-align:justify;margin-left:30px">
				<div style="margin-left:80px;font-size:14px">
					<li>Faculty and Staff Profiles</li>		
					<li>Users Level Functionalities</li>
					<li>Pre-Selection of Static Data</li>					
					<li>Multi-Schools Configuration</li>
					<li>Database Backup and Restore</li>
					<li>Generates Identification Cards</li>
					<li>Signature and Photo Matching</li>
				</div>
			</p><br>					
			<p style="text-align:justify;margin-left:30px">
