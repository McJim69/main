...
# Find the catch-all and replace port 80 with 8088
# The catch-all is:
#     location / {
#        proxy_pass http://10.0.10.51:80;
#        proxy_set_header Host $host;
import re
new_config = config.replace('proxy_pass http://10.0.10.51:80;', 'proxy_pass http://10.0.10.51:8088;')
