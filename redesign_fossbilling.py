...
with open('d:\\Server\\www\\fossbilling_order.html', 'r', encoding='utf-8') as f:
    html = f.read()
...
# Replace the original inline styles for max-width to allow the CSS to take over
html = html.replace('style="max-width: 320px;"', '')
html = html.replace('style="width: 30%; max-width: 90px;"', '')
html = html.replace('style="width: 30%; max-width: 90px;"', '') # in case of multiple

# Inject CSS before </head>
html = html.replace('</head>', premium_css + '\n</head>')

with open('d:\\Server\\www\\fossbilling_order_updated.html', 'w', encoding='utf-8') as f:
    f.write(html)

print("Updated HTML generated!")
