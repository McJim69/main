...
<div class="page-heading header-text" style="background:url(images/mcjim-cyberworks1.webp)no-repeat;background-size:cover;background-position:center center">
	<div class="container">
		<h1>Disclaimer</h1>
		<span>Last updated: March 02, 2024</span>
	</div>
</div>

<div class="container">
	<div class="media-container">
		<div class="terms col-md-12 align-center">
			<h1> &nbsp; </h1>
			<div style="text-align:justify">
				<h1>Disclaimer</h1>
				<p>
					All the information on this website - <a href="https://mcjim-server.com">https://mcjim-server.com</a> - 
					is published in good faith and for general information purpose only. McJim Cyberworks does not make any warranties 
					about the completeness, reliability and accuracy of this information. Any action you take upon the information you 
					find on this website (McJim Cyberworks), is strictly at your own risk. McJim Cyberworks will not be liable for any 
				...
				<ul>
				<li>
				<p>By email: info@mcjim-server.com</p>
				</li>
				<li>
